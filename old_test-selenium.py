...
# select_element = driver.find_element(By.CLASS_NAME, "form-row")
# options = select_element.find_elements(By.TAG_NAME, "div")
#
# for option in options:
#     print(option.text)

# grid = driver.find_element(By.CLASS_NAME, "mt-5") # able to see number of 3 room and 4 room flats available
# grid_options = grid.find_elements(By.)
# print(grid.text)
# select_element.select_by_value('0')

# form_rows = driver.find_element(By.CLASS_NAME, "row mb-5")
# print(form_rows.text)
...
#     print(opt.text)
#     opt.click()
# print(f"form_rows: {form_rows.text}, {form_rows.tag_name}")
